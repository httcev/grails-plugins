...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'de.httc.plugin.common.settings')}" />
	...
	<body>
		<g:form class="form-horizontal" url="[controller:'settings', action:'update', plugin:'httcCommon']" method="put"  enctype="multipart/form-data">
