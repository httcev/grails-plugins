<html>
	...
	<body>
		<ol class="breadcrumb">
			<li><a class="home" href="${createLink(uri: '/')}"><g:message code="de.httc.plugin.home"/></a></li>
		...
		<g:form url="[resource:user, action:'update', namespace:'admin']" method="PUT" class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
			<h1 class="page-header clearfix">
				...
				<div class="buttons pull-right">
					<g:link class="delete btn btn-danger" action="delete" namespace="admin" id="${user.id}" title="${message(code: 'default.button.delete.label', args:[entityName])}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">
