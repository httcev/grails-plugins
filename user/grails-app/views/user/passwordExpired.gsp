	...
	<div id="loginWrapper" class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title"><b><g:message code="de.httc.plugin.user.updatePassword.prompt" /></b></h1>
			</div>
			<form action="updatePassword" method="POST" role="form" autocomplete="off">
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="password" class="control-label"><g:message code="de.httc.plugin.user.updatePassword.current" />:</label>
					...
					<div class="form-group">
						<label for="password_new" class="control-label"><g:message code="de.httc.plugin.user.updatePassword.new" />:</label>
					...
					<div class="form-group">
						<label for="password_new_2" class="control-label"><g:message code="de.httc.plugin.user.updatePassword.new2" />:</label>
