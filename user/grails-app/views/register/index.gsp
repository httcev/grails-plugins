	...
	<g:else>
		<div id="loginWrapper" class="container">
			<div class="panel panel-primary">
				...
				<g:form url="[controller:'register', action:'register']" method="POST" role="form" autocomplete="off">
					...
					<div class="panel-footer text-center">
						<button type="submit" class="btn btn-success"><g:message code="spring.security.ui.register.submit" /></button>
					</div>
				</g:form>
			</div>
		</div>
