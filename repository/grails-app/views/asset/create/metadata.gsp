...
<%--		
		<div class="form-group ${hasErrors(bean: cmd, field: 'typeLabel', 'error')}">
			<label for="typeLabel" class="col-sm-2 control-label">
				<g:message code="de.httc.plugin.repository.asset.typeLabel" />:
			</label>
			<div class="col-sm-10"><g:textField name="typeLabel" class="form-control" value="${cmd?.typeLabel}"/></div>
		</div>
--%>		
		<div class="form-group ${hasErrors(bean: cmd, field: 'mimeType', 'error')}">
			<div class="col-sm-2">
				<label class="pull-right"><g:message code="app.meta.mimeType" />:</label>
			</div>
